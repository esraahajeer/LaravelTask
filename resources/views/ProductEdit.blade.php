                ...
                <div class="card" style="margin-bottom: 50px">
                    <div class="card-body">
                        @foreach ($product as $pro)
                            <form action="{{ route('editProduct', $pro['id']) }}" method="post"
                                ...
                                <div style=" display: flex;  justify-content: center;">
                                    <div class="form-group mb-4" style="align=center">
                                        <select style="width: 200px; align=center;" data-placeholder="Select Category"
                                            multiple class="center-block chosen-select" name="category[]">
                                            <?php $count = 0; ?>
